 ...
 * @param {(value: T, index: number, array: readonly T[]) => boolean} predicate
 ...
 * @returns {readonly S[]} - A new array that meet the condition specified in a `predicate` function.
 * @example
